...
export default function InicioPage() {
    // Datos falsos por ahora, luego los traeremos de Prisma
    const vacantesPrueba = [
        ...
        { id: 2, titulo: "Auxiliar Administrativo", empresa: "Grupo Hotelero Maya", tipo: "Empleo", ubicacion: "Tulum, Q. Roo", tiempo: "Hace 5 horas" },
        { id: 3, titulo: "Prácticas en Marketing Digital", empresa: "Agencia Creativa Roo", tipo: "Prácticas", ubicacion: "Cancún, Q. Roo", tiempo: "Hace 1 semana" },
    ];

    return (
        <div className="animate-in fade-in slide-in-from-bottom-4 duration-500">
            <h1 className="text-3xl font-bold text-gray-800 mb-2 tracking-tight">Buscar vacantes</h1>
            <p className="text-gray-500 mb-8">Encuentra estadías, prácticas o empleo con filtros rápidos.</p>
                ...
                {vacantesPrueba.map((vacante) => (
                    <div key={vacante.id} className="bg-white p-6 rounded-2xl border border-gray-100 shadow-sm hover:shadow-md transition-shadow group">
                        <div className="flex justify-between items-start mb-4">
                            <span className={`px-3 py-1 rounded-full text-xs font-semibold ${vacante.tipo === 'Estadía' ? 'bg-blue-100 text-blue-700' :
                                    vacante.tipo === 'Empleo' ? 'bg-emerald-100 text-emerald-700' :
