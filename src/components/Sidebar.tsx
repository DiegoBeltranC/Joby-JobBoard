    ...
    return (
        <>
            ...
            <nav className="flex-1 p-4 space-y-1.5 mt-2">
                ...
                <Link href="/reloj" className={`flex items-center gap-3 p-3.5 rounded-xl font-medium transition-all ${pathname === '/reloj' ? 'text-teal-800 bg-teal-50 font-semibold shadow-sm' : 'text-gray-500 hover:text-gray-800 hover:bg-gray-50 group'}`}>
                    <svg className={`w-5 h-5 ${pathname === '/reloj' ? 'text-teal-600' : 'text-gray-400 group-hover:text-gray-600 transition-colors'}`} fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>
                    Reloj Inteligente
                </Link>
